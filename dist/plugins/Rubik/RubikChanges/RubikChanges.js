...
class RubikChanges extends React.Component {
    constructor(props) {
        super(props);
        ...
        for (var side = 0; side < sides.length; side++) {
            for (var i1 = 0; i1 < 3; i1++) {
                for (var j = 0; j < 3; j++) {
                    ...
                    let [opacityA, colA] = getProminent(countA, key);
                    let [opacityB, colB] = getProminent(countB, key);
                    if (colA != colB) {
                        col = colB;
                        opacity = opacityB;
                    }
...
exports.RubikChanges = RubikChanges;
