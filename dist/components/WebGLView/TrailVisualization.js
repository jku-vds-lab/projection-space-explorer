...
// @ts-ignore
const square_white_png_1 = require("../../../textures/sprites/square_white.png");
class TrailVisualization {
    ...
    create(clusterObjects) {
        ...
        var pointMaterial = new THREE.ShaderMaterial({
            uniforms: {
                ...
                scale: { value: 1.0 },
                atlas: {
                    value: new THREE.TextureLoader().load(square_white_png_1.default)
                }
            },
            transparent: true,
    ...
    update(clusterObjects, zoom) {
        ...
        var color = this.mesh.geometry.attributes.customColor;
...
exports.TrailVisualization = TrailVisualization;
