...
var distance_functions_1 = __webpack_require__(/*! ../../Utility/Distances/distance_functions */ "./src/components/Utility/Distances/distance_functions.ts"); // create main global object
...
(function (global) {
  ...
  var tSNE = function tSNE(opt) {
    ...
    this.distanceFn = getopt(opt, "distanceFn", distance_functions_1.euclidean);
    this.iter = 0;
  };
